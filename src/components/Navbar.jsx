        ...
        <>
            <Nav>
                <div className="brand">
                    ...
                    <div className="toggle">
                        {
                            navbarState ? <VscChromeClose onClick={() => setNavbarState(!navbarState)} /> : <GiHamburgerMenu onClick={() => setNavbarState(!navbarState)} />
                        }
                    </div>
                </div>
                <ul>
            ...
            <ResponsiveNav state={navbarState}>
                <ul>
                    ...
                    <li><a href="#testimonial" onClick={() => setNavbarState(false)}>Testimonials</a></li>
                </ul>
            </ResponsiveNav>
        </>
    );
